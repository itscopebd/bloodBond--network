...
//     return (
//         <div className='mt-10'>
//             <h2 className='text-center text-3xl text-red-700 font-bold mb-5'>Our Story</h2>
//                 <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2'>
//                 <div className="img">
//                     <Image src={story} alt='image'/>
//                 </div>
//                 <div className="story">
//                      <p className=''>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita ea laboriosam perferendis maiores cupiditate quibusdam deleniti voluptas, vitae qui repudiandae sit, odit eveniet debitis placeat, aliquam nemo suscipit quo omnis quos? Perspiciatis et modi magnam, cumque distinctio repellat earum rem quibusdam, atque cupiditate nulla asperiores. Maiores ipsa qui obcaecati perferendis similique error officiis ullam facere dolores, ea officia, quas quasi. Nobis rem ea alias et eum maxime, atque, sed natus animi optio maiores repellendus! Voluptatibus excepturi nostrum nisi! Consequatur, accusantium culpa. Id a sed velit? Odio accusamus pariatur labore? Nam consequatur iste sint? Nam cum vel velit, doloremque magnam quas.</p>
//                 </div>
//                 </div>
//             </div>
//     );
        ...
        <div className='mt-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 items-center'>
                ...
                <div className='text-lg'>
                    <p className='w-10/12 text-justify flex justify-center items-center'>
