...
const ContactUs = () => {
    ...
    return (
        <section>
            <h1 className="text-5xl text-center font-bold text-red-500 pt-12">Contact Us</h1>
                <p className="text-gray-500 pt-10 text-center">Connect with us easily through our contact information or send us a message via our user-friendly contact form. 
                   <br /><br /> We are here to help and look forward to hearing from you.
                </p>
                <div className='mt-10 grid lg:grid-cols-3 justify-items-center '>
                    <div className='text-justify p-10 bg-blue-100 shadow-md rounded '>
